...
mod test {
    ...
    lazy_static! {
        ...
        static ref ANSWERS: [(Answer, Answer); 25] = [
            ...
            (Answer::Numeric(12979353889), Answer::Numeric(1449)),
            (Answer::Numeric(926), Answer::String(String::from("az,ed,hz,it,ld,nh,pc,td,ty,ux,wc,yg,zz"))),
